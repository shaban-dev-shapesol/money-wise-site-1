  ...
  const values = [
    {
      icon: Target,
      title: "Our Mission",
      description: "To empower individuals to take control of their finances with simple, practical tools that make budgeting accessible to everyone.",
    },
    {
      icon: Eye,
      title: "Our Vision",
      description: "A world where financial stress is minimized and everyone has the knowledge and tools to build a secure future.",
    },
    {
      icon: Users,
      title: "Our Community",
      description: "We're building a community of like-minded individuals who support each other on their financial journey.",
    },
    {
      icon: Heart,
      title: "Our Values",
            ...
            <SlideInLeft>
              <div>
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    Our goal is to help you spend less time worrying about money and more time enjoying life, knowing you're in control.
                  </p>
                </div>
              </div>
            </SlideInLeft>
